...
<body>
	...
	<div class="tamaño rounded row col-10 position-absolute top-50 start-50 translate-middle fw-bold text-center mx-auto">
		<div class="titulo">
			<h2>Actualizar Entrada</h2>
		</div><br>
	<form class="text-uppercase col-12 row ms-1" action="<?=$_SERVER['PHP_SELF']?>" method="POST">
		...
		<div class="form-group col-7 p-1">
			...
			<input class="form-control border border-dark" type="text" name="proveedor" value="<?php echo $proveedor; ?>">
		</div>
