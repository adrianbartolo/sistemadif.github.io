...
<?php 
	if (isset($_POST['enviar'])) {
		...
		include("conex.php");
		$sql = " INSERT INTO salidas (norecibo, fecha, codigo, cantidad, folio, recibe, entrega) values ('".$norecibo."', '".$fecha."', '".$codigo."', '".$cantidad."', '".$folio."', '".$recibe."','".$entrega."') ";
			$resultado = mysqli_query($conexion, $sql);
			if ($resultado) {
...
<br>
<a class="btn btn-success mb-2" type="submit" id="btn-modal" data-toggle="modal" data-target="#salida">Nueva Salida</a>
<br>
<table class="table table-bordered" id="tabla">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<a class="btn btn-primary" href=<?php echo "editarsalida.php?norecibo=".$fila['norecibo'].""; ?>>Editar</a>
				<a class="btn btn-danger" href=<?php echo "eliminarsalida.php?norecibo=".$fila['norecibo'].""; ?> onclick='return confirmar()'>Eliminar</a>
				<a class="btn btn-success" href=<?php echo "pdfsalida.php?norecibo=".$fila['norecibo'].""; ?>>PDF</a>
...
<div class="modal fade fw-bold text-center" id="salida">
  <div class="modal-dialog  modal-dialog-centered" role="document">
    <div class="modal-content tamaño py-2">
        <h5 class="modal-title text-center">REGISTRO DE SALIDAS</h5>
      <div class="modal-body">
      	<form class="row text-uppercase" action="<?=$_SERVER['PHP_SELF']?>" method="POST">
		<div class="form-group col-5 p-1">
			<label>N° Recibo</label>
			<input class="form-control border border-dark" type="text" name="norecibo" required>
		</div>
